'''
OpenClip uses nn.MultiheadAttention which is not amenable to LoRA as of yet.
Need to seperate out the qkv to attach LORA adapters.
Thus need to replace nn.MultiHeadAttention module with this module
'''
