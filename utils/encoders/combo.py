...
class ComboPolicy(PolicyNetwork):
    ...
    def _load_encoder(self):
        sam = sam_model_registry['vit_b'](checkpoint='/projects/p31777/ryan/encoders/sam_vit_b_01ec64.pth')
        return sam.image_encoder, 9216 #50176 # 9216
